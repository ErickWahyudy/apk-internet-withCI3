...
<head>
    <meta charset="utf-8">
    <title><?= $judul ?> KASSANDRAWIFI | <? echo $data_cek['nama']; ?></title>
            ...
            <div class="navbar-nav me-auto p-3 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu border-0 rounded-0 rounded-bottom m-0">
                        <a href="feedback" class="dropdown-item active">Feedback</a>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="position-relative mx-auto" style="max-width: 400px;">
                        ...
                        <a href="<?= base_url('template/kassandra-wifi') ?>/contact" class="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2">klik..</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php
    ...
    if ($query_simpan){
      ...
      Swal.fire({title: 'Terima kasih, masukkan anda sudah kami terima dan akan kami baca demi meningkatkan pelayanan hotspot KassandraWiFi',text: '',icon: 'success',confirmButtonText: 'OKE'
          ...
          if (result.value) {
              window.location = 'feedback_p?id=".$_POST['no_hp']."';
          }
      })</script>";
