    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav me-auto p-3 p-lg-0">
                <a href="landingpage" class="nav-item nav-link <?php if($this->uri->segment(1)=="landingpage"){echo "active";}?>">Home</a>
                <a href="promo" class="nav-item nav-link <?php if($this->uri->segment(1)=="promo"){echo "active";}?>">Promo</a>
                <a href="about" class="nav-item nav-link <?php if($this->uri->segment(1)=="about"){echo "active";}?>">About Us</a>
                <a href="service" class="nav-item nav-link <?php if($this->uri->segment(1)=="service"){echo "active";}?>">Services</a>
                <a href="project" class="nav-item nav-link <?php if($this->uri->segment(1)=="project"){echo "active";}?>">Projects</a>
                <a href="speedtest" class="nav-item nav-link <?php if($this->uri->segment(1)=="speedtest"){echo "active";}?>">Speedtest</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                    <div class="dropdown-menu border-0 rounded-0 rounded-bottom m-0">
                        <a href="feedback" class="dropdown-item <?php if($this->uri->segment(1)=="feedback"){echo "active";}?>">Feedback</a>
                        <a href="lapor" class="dropdown-item <?php if($this->uri->segment(1)=="lapor"){echo "active";}?>">Lapor ada kendala</a>
                        <a href="feature" class="dropdown-item <?php if($this->uri->segment(1)=="feature"){echo "active";}?>">Features</a>
                        <a href="team" class="dropdown-item <?php if($this->uri->segment(1)=="team"){echo "active";}?>">Our Team</a>
                        <a href="testimonial" class="dropdown-item <?php if($this->uri->segment(1)=="testimonial"){echo "active";}?>">Testimonial</a>
                        <a href="404" class="dropdown-item <?php if($this->uri->segment(1)=="404"){echo "active";}?>">404 Page</a>
                    </div>
                </div>
