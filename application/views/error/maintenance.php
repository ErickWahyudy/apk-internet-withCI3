...
<body background="<?= base_url('template/kassandra-wifi') ?>/img/img/white.jpg" style="background-size: cover; background-repeat: repeat; background-position: center center;">
    <!-- Spinner Start -->
    <div id="spinner"
